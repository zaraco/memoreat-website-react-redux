...
export default function Register() {
    ...
    const {register, authRegisterForm, fetchAuthRegister, error, isLoggedIn, isLoadingRegister} = useAuth();
    ...
    return (
        <>
            ...
            {(isLoadingRegister === true) ? <CircularProgress color="secondary"/> :
                                        ...
                                        endAdornment={
                                            <InputAdornment position="end">
                                                <IconButton
                                                    ...
                                                    edge="end"
                                                >
                                                    {register && register.showPassword ? <Visibility/> :
                                                        <VisibilityOff/>}
                                                </IconButton>
                                            </InputAdornment>
                                        }
